      ...
      <FadeIn>
        <section className="py-20 px-6 lg:px-8">
          <div className="mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <h2 className="text-h2 mb-6">Building the Library</h2>
              <p className="text-lg text-white/90 leading-[27px]">
                A scalable production framework designed to grow with Pentair&rsquo;s product catalog — consistent, efficient, and ready to deploy.
              </p>
            </div>
          </div>
        </section>
